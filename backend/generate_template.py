...
# A=题型, B=题干, C=选项A, D=选项B, E=选项C, F=选项D, G=参考答案, H=分值, I=附件, J=备注, K=数据, L=Stata, M=AI, N=Python
...
# Examples: [题型, 题干, A, B, C, D, 参考答案, 分值, 附件, 备注, 数据, Stata, AI, Python]
examples = [
...
# v5.2: Dropdown for Python
dv_python = DataValidation(type='list', formula1='"是,否"',
                            allow_blank=True, showDropDown=False)
dv_python.error = '请选择是/否'
dv_python.errorTitle = 'Python选择错误'
